...
public class PrimaryJpaConfig {
    static final String REPOSITORY_PACKAGE = "com.yuzu.springsessiondemo.repositories";
    private static final String ENTITY_PACKAGE = "com.yuzu.springsessiondemo.entity";
