...
public class SecondJpaConfig {
    static final String REPOSITORY_PACKAGE = "com.yuzu.springsessiondemo.secondrepositories";
    private static final String ENTITY_PACKAGE = "com.yuzu.springsessiondemo.secondentity";
